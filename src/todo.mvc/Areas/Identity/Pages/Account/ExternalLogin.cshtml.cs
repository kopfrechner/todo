    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // var aTenant = tenants?.FirstOrDefault();
                var aTenant = (Tenant) null;
                if (aTenant == null)
                {
                    throw new InvalidOperationException("Cannot create user without tenant");
                }
                
                var result = await _userManager.CreateAsync(user, aTenant.Id);
                if (result.Succeeded)
                {
